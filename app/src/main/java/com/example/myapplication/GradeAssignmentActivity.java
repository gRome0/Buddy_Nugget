    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                { int assignmentId = assignmentMap.get(selectedLabel); float score = Float.parseFloat(scoreText);
                    User student = db.userDao().findByStudentId(studentIdText);
                    if (student == null)
                    { Toast.makeText(GradeAssignmentActivity.this, "Student ID not found", Toast.LENGTH_SHORT).show(); return; }
